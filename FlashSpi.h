...
/** Created: 09/05/2026                            IDE: Mounriver Studio    **/
...
void Nor_EraseAll(){
    ...
    while((SPI_DATAIN(8))&1<<0){}
    SPI_CS1_HIGH;
}


void Nor_EraseSector(uint16_t s){
...
void Nor_EraseBlock32(uint16_t b){
...
void Nor_EraseBlock64(uint16_t b){
...
void Nor_PageProgram(uint32_t pg, uint16_t boff, uint8_t data[]){
